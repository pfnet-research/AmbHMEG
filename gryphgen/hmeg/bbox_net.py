...
if __name__ == "__main__":
    ...
    def _build_crohme_dsets(crohme_dir, image_size=(256, 256)):
        ...
        train_dset = CROHMELabelGraphDataset(
            crohme_dir, names[:-500], nc=nc, image_size=image_size
        )
        val_dset = CROHMELabelGraphDataset(
            crohme_dir, names[-500:], nc=nc, image_size=image_size
        )
    ...
    boxes_pred, graph_embeddings = box_net(
        objs.cuda(), triples.cuda(), obj_to_img.cuda()
    )
